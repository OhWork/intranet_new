<?php
			...
			$rs = $db->findByPK21('news','user','news.user_user_id','user.user_id',$startpoint,$limit,'news_date')->execute();
?>
			...
			<div class="col-xl-5 col-lg-5 col-md-5 col-sm-5 col-5 shadow" style="background-color:#ffffff;border-right:5px solid #f5f5f5;">
				<div class='row'>
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
						<div class='row'>
							<img height="300" width="100%" src='images/view2.jpg' />
						</div>
					</div>
							...
							<div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-8">
								<div class='row'>
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mt-3">
										<a href="#" style="color:#000000;">How Did van Gogh’s Turbulent Mind Depict One of the Most</a>
									</div>
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="color:#8d8d8d;">
