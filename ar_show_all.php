...
<?php echo $form->close();
    ...
    <div class='col-12 mt-3' style="float: left;">
        <div class='col-12'><h3>รายงานบัญชีสัตว์ประจำ<?php echo $thai_date; ?></h3>
    <?php
    }else if($search == 2){ ?>
    <div class='col-12 mt-3' style="float: left;">
        <div class='col-12'><h3>รายงานบัญชีสัตว์ระหว่างวันที่<?php echo $thai_date2_1; ?> ถึง <?php echo $thai_date2_2; ?></h3>
<?php
    }else if($search == 3){
    switch($month){
        ...
        <div class='col-12 mt-3' style="float: left;">
			<div class='col-12'>
				<h3>รายงานบัญชีสัตว์ประจำเดือน <?php echo $monthtxt; ?> พ.ศ. <?php echo $yearmonth; ?></h3>
    <?php }else if($search == 4){ ?>
	    <div class='col-12 mt-3' style="float: left;">
			<div class='col-12'>
				<h3>รายงานบัญชีสัตว์ประจำ <?php echo $textqua; ?> พ.ศ. <?php echo $yearqua; ?></h3>
	<?php }else if($search == 5){ ?>
	    <div class='col-12 mt-3' style="float: left;">
			<div class='col-12'>
				<h3>รายงานบัญชีสัตว์ประจำปี <?php echo $yearonly; ?></h3><!-- //แสดงวันที่ -->
    <?php }else{ ?>
        <div class='col-12 mt-3' style="float: left;">
			<div class='col-12'>
				<h3>รายงานบัญชีสัตว์ <?php echo $thai_date;?></h3>
	<?php }
