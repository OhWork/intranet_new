						...
						<div class='col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12'>
							<div class='row'>
								<div class='col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 ml-5'>
									<div class='row'>
										<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" align="center">
											<?php $rsshowimg1 = $db->findByPK12('conferimg','conferimg_position',1,'confer_id',$_GET['id'])->executeAssoc();
								...
								<div class='col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 ml-5'>
									<div class='row'>
										<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" align="center">
											<?php $rsshowimg1 = $db->findByPK12('conferimg','conferimg_position',2,'confer_id',$_GET['id'])->executeAssoc(); ?>
								...
								<div class='col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 ml-5'>
									<div class='row'>
										<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" align="center">
											<?php $rsshowimg1 = $db->findByPK12('conferimg','conferimg_position',3,'confer_id',$_GET['id'])->executeAssoc(); ?>
