...
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mt-3" style="display:table">
	<div class="row">
			<?php
				$rs = $db->specifytable('*','bn','bn_enable = 1 LIMIT 4')->execute();
				foreach($rs as $showrs){
			?>
			<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12" style="display:table-cell">
				<a href="<?php echo $showrs['bn_link'];?>">
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 bcmn bner" style="height:100%;"><h5 class="mb-0"><?php echo $showrs['bn_name'];?></h5></div>
				</a>
			</div>
			<?php }?>
	</div>
