<?php
    if (!empty($_SESSION['user_name'])):
        ...
        $button = new buttonok("ตรวจสอบเรียบร้อย","","btn btn-success btn-block bt3success col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12","");
            ...
            echo $form->open("form_reg","frmMain","col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mt-3","zlfot_insert_status.php","");
           ...
           ?> <input type='hidden' name='zlfot_status' value='R'> <?php
            echo $button;
             echo $form->close();
             endif;
             ?> 
