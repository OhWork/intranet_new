					...
					<div class='col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4' style="color:#f44336;">
						<div class='row'>
							<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mt-3">
								...
								<p>2.สำนักดิจิทัลและสารสนเทศ ไม่รับผิดชอบต่อความเสียหายของข้อมูลทุกกรณี</p>
								<p>3.กรุณา Print แบบฟอร์มแจ้งซ่อมให้สำนักดิจิทัลและสารสนเทศ เพื่อขออนุมัติ ผู้อำนวยการสำนักดิจิทัลและสารสนเทศดำเนินการแก้ไขต่อ</p>
							</div>
						</div>
					</div>
				</div>
