...
<?php    echo $form->open("form_reg","frmMain","","cs_insert_problem.php","");?>
			<div class='col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12' style="float: left;">
				<div class='row'>
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
	...
	<div class='col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12' style="float: right;color:#f44336;">
		<div class='row'>
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				<h3>*** คำเตือน ***</h3>
