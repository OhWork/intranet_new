	...
	class db_tools{
		...
		function findByPK44DESC($table,$table2,$table3,$table4,$column1,$value1,$column2,$value2,$column3,$value3,$column4,$value4,$order){
    		...
    		return $this;
                                ...
                                function findByPK56DESCLIMIT($table,$table2,$table3,$table4,$table5,$column1,$value1,$column2,$value2,$column3,$value3,$column4,$value4,$column5,$value5,$column6,$value6,$order,$limit){
    		$this->sql = "SELECT * FROM $table,$table2,$table3,$table4,$table5 WHERE $column1 = $value1 AND $column2 = $value2 AND $column3 = $value3 AND $column4 = $value4 AND $column5 = $value5 AND $column6 = $value6 ORDER BY $order DESC LIMIT $limit";
    		return $this;
		}
		...
		function findByPK47LimitBETWEENASC($table1,$table2,$table3,$table4,$column1,$value1,$column2,$value2,$column3,$value3,$column4,$value4,$column5,$value5,$column6,$value6,$column7,$value7,$order){
			...
			return $this;
                ...
                function findByPK87($table1,$table2,$table3,$table4,$table5,$table6,$table7,$table8,$column1,$value1,$column2,$value2,$column3,$value3,$column4,$value4,$column5,$value5,$column6,$value6,$column7,$value7){
			$this->sql = "SELECT * FROM $table1,$table2,$table3,$table4,$table5,$table6,$table7,$table8 WHERE $column1 = $value1 && $column2 = $value2 && $column3 = $value3 && $column4 = $value4 && $column5 = $value5 && $column6 = $value6 && $column7 = $value7";
			return $this;
		}
                function findByPK88($table1,$table2,$table3,$table4,$table5,$table6,$table7,$table8,$column1,$value1,$column2,$value2,$column3,$value3,$column4,$value4,$column5,$value5,$column6,$value6,$column7,$value7,$column8,$value8){
			$this->sql = "SELECT * FROM $table1,$table2,$table3,$table4,$table5,$table6,$table7,$table8 WHERE $column1 = $value1 && $column2 = $value2 && $column3 = $value3 && $column4 = $value4 && $column5 = $value5 && $column6 = $value6 && $column7 = $value7 && $column8 = $value8";
			return $this;
		}
                function findByPK89($table1,$table2,$table3,$table4,$table5,$table6,$table7,$table8,$column1,$value1,$column2,$value2,$column3,$value3,$column4,$value4,$column5,$value5,$column6,$value6,$column7,$value7,$column8,$value8,$column9,$value9){
			$this->sql = "SELECT * FROM $table1,$table2,$table3,$table4,$table5,$table6,$table7,$table8 WHERE $column1 = $value1 && $column2 = $value2 && $column3 = $value3 && $column4 = $value4 && $column5 = $value5 && $column6 = $value6 && $column7 = $value7 && $column8 = $value8 && $column9 = $value9";
			return $this;
		}
