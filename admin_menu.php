             ...
             <?php }
              ...
              <?php }
                ...
                <ul class="sub-menu collapse on-sub" id="cs">
				        ...
				        <?php
    				          if($user_zoo == 10){?>
							<a class="dropdown-item" href="admin_index.php?url=cs_show_ip.php&id=1"><span data-feather="chevron-right"></span>องค์การสวนสัตว์</a>
						<?php }
						if($user_zoo == 10 || $user_zoo == 11){?>
							<a class="dropdown-item" href="admin_index.php?url=cs_show_ip.php&id=11"><span data-feather="chevron-right"></span>สวนสัตว์ดุสิต</a>
						<?php }
						if($user_zoo == 10 || $user_zoo == 12){?>
							<a class="dropdown-item" href="admin_index.php?url=cs_show_ip.php&id=12"><span data-feather="chevron-right"></span>สวนสัตว์เปิดเขาเขียว</a>
						<?php }
						if($user_zoo == 10 || $user_zoo == 13){?>
							<a class="dropdown-item" href="admin_index.php?url=cs_show_ip.php&id=13"><span data-feather="chevron-right"></span>สวนสัตว์เชียงใหม่</a>
						<?php }
						if($user_zoo == 10 || $user_zoo == 14){?>
							<a class="dropdown-item" href="admin_index.php?url=cs_show_ip.php&id=14"><span data-feather="chevron-right"></span>สวนสัตว์นครราชสีมา</a>
						<?php }
						if($user_zoo == 10 || $user_zoo == 15){?>
							<a class="dropdown-item" href="admin_index.php?url=cs_show_ip.php&id=15"><span data-feather="chevron-right"></span>สวนสัตว์สงขลา</a>
						<?php }
						if($user_zoo == 10 || $user_zoo == 16){?>
							<a class="dropdown-item" href="admin_index.php?url=cs_show_ip.php&id=16"><span data-feather="chevron-right"></span>สวนสัตว์อุบลราชธานี</a>
						<?php }
						if($user_zoo == 10 || $user_zoo == 17){?>
							<a class="dropdown-item" href="admin_index.php?url=cs_show_ip.php&id=17"><span data-feather="chevron-right"></span>สวนสัตว์ขอนแก่น</a>
						<?php }
						if($user_zoo == 10 || $user_zoo == 18){?>
							<a class="dropdown-item" href="admin_index.php?url=cs_show_ip.php&id=18"><span data-feather="chevron-right"></span>โครงการคชอาณาจักร</a>
						<?php }?>
				        </ul>
				        ...
				        <a class="dropdown-item" href="admin_index.php?url=admin_cs_index.php&url2=cs_show_iptools.php&id=1"><span data-feather="chevron-right"></span>Server</a>
				        </ul>
