<?php
	...
	if($eventconfer_statuszpow == 'W'){
	 $rszpowait = $db->countTable23('eventconfer','confer','eventconfer_status',"'W'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',3)->execute();
	 while ($rszposhow = mysqli_fetch_array($rszpowait,MYSQLI_NUM)){
	 print_r($rszposhow[0]);};
	}
	elseif($eventconfer_statuszpoy == 'Y'){
	 $rszpopass = $db->countTable23('eventconfer','confer','eventconfer_status',"'Y'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',3)->execute();
	 while ($rszposhow2 = mysqli_fetch_array($rszpopass,MYSQLI_NUM)){
	 print_r($rszposhow2[0]);};
	}
	elseif($eventconfer_statuszpon == 'N'){
	 $rszponopass = $db->countTable23('eventconfer','confer','eventconfer_status',"'N'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',3)->execute();
	 while ($rszposhow3 = mysqli_fetch_array($rszponopass,MYSQLI_NUM)){
	 print_r($rszposhow3[0]);};
	}
	elseif($eventconfer_statuszpoc == 'C'){
	 $rszpocancel = $db->countTable23('eventconfer','confer','eventconfer_status',"'C'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',3)->execute();
	 while ($rszposhow4 = mysqli_fetch_array($rszpocancel,MYSQLI_NUM)){
	 print_r($rszposhow4[0]);};
	}
	elseif($eventconfer_statusonlinew == 'W'){
	 $rszpoonlinewait = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'W'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',3)->execute();
	...
	elseif($eventconfer_statusonliney == 'Y'){
		$rszpoonlinepass = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'Y'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',3)->execute();
	...
	elseif($eventconfer_statusonlinen == 'N'){
	   $rszpoonlinenopass = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'N'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',3)->execute();
	...
	elseif($eventconfer_statusonlinec == 'C'){
	   $rszpoonlinecancel = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'C'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',3)->execute();
	...
	elseif($eventconfer_statusdusitw == 'W'){
	 $rsdusitwait = $db->countTable23('eventconfer','confer','eventconfer_status',"'W'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',11)->execute();
	 while ($showdusitwait = mysqli_fetch_array($rsdusitwait,MYSQLI_NUM)){
	 print_r($showdusitwait[0]);};
	}
	elseif($eventconfer_statusdusity == 'Y'){
	$rsdusitpass = $db->countTable23('eventconfer','confer','eventconfer_status',"'Y'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',11)->execute();
    ...
    $rsdusitnopass = $db->countTable23('eventconfer','confer','eventconfer_status',"'N'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',11)->execute();
    ...
    $rsdusitcancel = $db->countTable23('eventconfer','confer','eventconfer_status',"'C'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',11)->execute();
	...
	elseif($eventconfer_statusdusitonlinew == 'W'){
	 $rsdusitonlinewait = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'W'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',11)->execute();
	...
	elseif($eventconfer_statusdusitonliney == 'Y'){
	 $rsdusitonlinepass = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'Y'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',11)->execute();
    ...
    $rsdusitonlinenopass = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'N'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',11)->execute();
    ...
    $rsdusitonlinecancel = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'C'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',11)->execute();
	...
	elseif($eventconfer_statuskhaokeaww == 'W'){
	 $rskhaokeawwait = $db->countTable23('eventconfer','confer','eventconfer_status',"'W'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',12)->execute();
	...
	elseif($eventconfer_statuskhaokeawy == 'Y'){
	 $rskhaokeawpass = $db->countTable23('eventconfer','confer','eventconfer_status',"'Y'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',12)->execute();
	...
	elseif($eventconfer_statuskhaokeawn == 'N'){
     $rskhaokeawnopass = $db->countTable23('eventconfer','confer','eventconfer_status',"'N'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',12)->execute();
	...
	elseif($eventconfer_statuskhaokeawc == 'C'){
     $rskhaokeawcancel = $db->countTable23('eventconfer','confer','eventconfer_status',"'C'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',12)->execute();
	...
	elseif($eventconfer_statuskhaokeawonlinew == 'W'){
	 $rskhaokeawonlinewait = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'W'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',12)->execute();
	...
	elseif($eventconfer_statuskhaokeawonliney == 'Y'){
	 $rskhaokeawonlinepass = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'Y'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',12)->execute();
	...
	elseif($eventconfer_statuskhaokeawonlinen == 'N'){
     $rskhaokeawonlinenopass = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'N'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',12)->execute();
	...
	elseif($eventconfer_statuskhaokeawonlinec == 'C'){
     $rskhaokeawonlinecancel = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'C'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',12)->execute();
...
// สวนสัตว์เชียงใหม่
	elseif($eventconfer_statuschangmaiw == 'W'){
	 $rschiangmaiwait = $db->countTable23('eventconfer','confer','eventconfer_status',"'W'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',13)->execute();
	...
	elseif($eventconfer_statuschangmaiy == 'Y'){
	 $rschiangmaipass = $db->countTable23('eventconfer','confer','eventconfer_status',"'Y'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',13)->execute();
	...
	elseif($eventconfer_statuschangmain == 'N'){
     $rschiangmainopass = $db->countTable23('eventconfer','confer','eventconfer_status',"'N'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',13)->execute();
	...
	elseif($eventconfer_statuschangmaic == 'C'){
     $rschangmaicancel = $db->countTable23('eventconfer','confer','eventconfer_status',"'C'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',13)->execute();
	...
	elseif($eventconfer_statuschangmaionlinew == 'W'){
	 $rschiangmaionlinewait = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'W'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',13)->execute();
	...
	elseif($eventconfer_statuschangmaionliney == 'Y'){
	 $rschiangmaionlinepass = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'Y'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',13)->execute();
	...
	elseif($eventconfer_statuschangmaionlinen == 'N'){
     $rschiangmaionlinenopass = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'N'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',13)->execute();
	...
	elseif($eventconfer_statuschangmaionlinec == 'C'){
     $rschiangmaionlinecancel = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'C'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',13)->execute();
...
//สวนสัตว์โคราช
	elseif($eventconfer_statuskoratw == 'W'){
	 $rskoratwait = $db->countTable23('eventconfer','confer','eventconfer_status',"'W'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',14)->execute();
	 while ($showkoratwait = mysqli_fetch_array($rskoratwait,MYSQLI_NUM)){
	 print_r($showkoratwait[0]);};
	}
	elseif($eventconfer_statuskoraty == 'Y'){
	 $rskoratpass = $db->countTable23('eventconfer','confer','eventconfer_status',"'Y'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',14)->execute();
	...
	elseif($eventconfer_statuskoratn == 'N'){
     $rskoratnopass = $db->countTable23('eventconfer','confer','eventconfer_status',"'N'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',14)->execute();
	...
	elseif($eventconfer_statuskoratc == 'C'){
     $rskoratcancel = $db->countTable23('eventconfer','confer','eventconfer_status',"'C'",'confer_conferroom_id','confer.conferroom_id','eventconfer_vdocon','1','confer.zoo_zoo_id',14)->execute();
	...
	elseif($eventconfer_statuskoratonlinew == 'W'){
	 $rskoratonlinewait = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'W'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',14)->execute();
	...
	elseif($eventconfer_statuskoratonliney == 'Y'){
	 $rskoratonlinepass = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'Y'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',14)->execute();
	...
	elseif($eventconfer_statuskoratonlinen == 'N'){
     $rskoratonlinenopass = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'N'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',14)->execute();
	...
	elseif($eventconfer_statuskoratonlinec == 'C'){
     $rskoratonlinecancel = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'C'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',14)->execute();
...
// สวนสัตว์สงขลา
	elseif($eventconfer_statussongkhlaw == 'W'){
	 $rssongkhlawait = $db->countTable23('eventconfer','confer','eventconfer_status',"'W'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',15)->execute();
	...
	elseif($eventconfer_statussongkhlay == 'Y'){
	 $rssongkhlapass = $db->countTable23('eventconfer','confer','eventconfer_status',"'Y'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',15)->execute();
	...
	elseif($eventconfer_statussongkhlan == 'N'){
     $rssongkhlanopass = $db->countTable23('eventconfer','confer','eventconfer_status',"'N'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',15)->execute();
	...
	elseif($eventconfer_statussongkhlac == 'C'){
     $rssongkhlacancel = $db->countTable23('eventconfer','confer','eventconfer_status',"'C'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',15)->execute();
	...
	elseif($eventconfer_statussongkhlaonlinew == 'W'){
	 $rssongkhlaonlinewait = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'W'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',15)->execute();
	...
	elseif($eventconfer_statussongkhlaonliney == 'Y'){
	    $rssongkhlaonlinepass = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'Y'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',15)->execute();
	...
	elseif($eventconfer_statussongkhlaonlinen == 'N'){
         $rssongkhlaonlinenopass = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'N'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',15)->execute();
	...
	elseif($eventconfer_statussongkhlaonlinec == 'C'){
         $rssongkhlacancelonline = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'C'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',15)->execute();
...
elseif($eventconfer_statusubonw == 'W'){
	 $rsubonwait = $db->countTable23('eventconfer','confer','eventconfer_status',"'W'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',16)->execute();
	 while ($showubonwait = mysqli_fetch_array($rsubonwait,MYSQLI_NUM)){
	 print_r($showubonwait[0]);};
	}
	elseif($eventconfer_statusubony == 'Y'){
	 $rsubonpass = $db->countTable23('eventconfer','confer','eventconfer_status',"'Y'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',16)->execute();
	 while ($rsubonpassshow = mysqli_fetch_array($rsubonpass,MYSQLI_NUM)){
	 print_r($rsubonpassshow[0]);};
	}
	elseif($eventconfer_statusubonn == 'N'){
     $rsubonnopass = $db->countTable23('eventconfer','confer','eventconfer_status',"'N'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',16)->execute();
   ...
   elseif($eventconfer_statusubonc == 'C'){
     $rsuboncancel = $db->countTable23('eventconfer','confer','eventconfer_status',"'C'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',16)->execute();
	...
	elseif($eventconfer_statusubononlinew == 'W'){
	 $rsubononlinewait = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'W'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',16)->execute();
	...
	elseif($eventconfer_statusubononliney == 'Y'){
	     $rsubononlinepass = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'Y'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',16)->execute();
	...
	elseif($eventconfer_statusubononlinen == 'N'){
         $rsubononlinenopass = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'N'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',16)->execute();
	...
	elseif($eventconfer_statusubononlinec == 'C'){
         $rsuboncancelonline = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'C'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',16)->execute();
...
elseif($eventconfer_statuskhonekaenw == 'W'){
	 $rskhonekaenwait = $db->countTable23('eventconfer','confer','eventconfer_status',"'W'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',17)->execute();
	...
	elseif($eventconfer_statuskhonekaeny == 'Y'){
	 $rskhonekaenpass = $db->countTable23('eventconfer','confer','eventconfer_status',"'Y'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',17)->execute();
	...
	elseif($eventconfer_statuskhonekaenn == 'N'){
     $rskhonekaennopass = $db->countTable23('eventconfer','confer','eventconfer_status',"'N'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',17)->execute();
     ...
     $rskhonekaencancel = $db->countTable23('eventconfer','confer','eventconfer_status',"'C'",'confer_conferroom_id','confer.conferroom_id','confer.zoo_zoo_id',17)->execute();
	...
	elseif($eventconfer_statuskhonekaenonlinew == 'W'){
	 $rskhonekaenonlinewait = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'W'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',17)->execute();
	...
	elseif($eventconfer_statuskhonekaenonliney == 'Y'){
	     $rskhonekaenonlinepass = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'Y'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',17)->execute();
	...
	elseif($eventconfer_statuskhonekaenonlinen == 'N'){
         $rskhonekaenonlinenopass = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'N'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',17)->execute();
	...
	elseif($eventconfer_statuskhonekaenonlinec == 'C'){
         $rskhonekaencancelonline = $db->countTable25('eventconfer','confer','eventconfer_status',"'Y'",'eventconfer_status_online',"'C'",'confer_conferroom_id','confer.conferroom_id','eventconfer_status_conferonline','1','confer.zoo_zoo_id',17)->execute();
