...
*/
    ...
    if(!empty($_GET['id'])){
		$id = $_GET['id'];
		$r = $db->findByPK44('eventconfer','confer','zoo','headncf','confer_confer_id','conferroom_id','zoo_zoo_id','zoo_id','headncf_headncf_id','headncf_id','eventconfer_id',$id)->executeRow();
		 $year = date("Y")+543;
          $md = date("m-d");
          $time = date("H:i");
