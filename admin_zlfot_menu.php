                <a class="nav-link collapsed nav-link-23 edittext mucl" id="nav-29-animate-2" href="#zlfot" data-toggle="collapse" data-target="#zlfot">
                    <i class="fas fa-newspaper mr-3"></i><span>ระบบสโมสรผู้รักสวนสัตว์</span>
                </a>
              <!-- sub menu -->
              <ul class="sub-menu collapse on-sub" id="zlfot">
	                <a class="nav-link edittext mucl" id="nav-1-animate-1" href="admin_index.php?url=zlfot_checkmember.php">
                            <span data-feather="search"></span>ค้นหาการเป็นสมาชิก</a>
                        <a class="nav-link edittext mucl" id="nav-1-animate-1" href="admin_index.php?url=zlfot_add_member.php">
                            <span data-feather="user-plus"></span>สมัครสมาชิก</a>
