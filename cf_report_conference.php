<?php
	...
	$rs = $db->findByPK55('eventconfer','confer','subzoo','zoo','headncf','confer_confer_id','conferroom_id','subzoo_subzoo_id','subzoo_id','subzoo_zoo_zoo_id','zoo_id','headncf_headncf_id','headncf_id','eventconfer_id',$id)->executeAssoc();
