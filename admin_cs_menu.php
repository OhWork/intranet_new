<a class="nav-link collapsed nav-link-1 edittext mucl" href="#cs" data-toggle="collapse" data-target="#cs"><span data-feather="cpu"></span>ระบบแจ้งซ่อมคอมพิวเตอร์</a>
    <!-- sub menu -->
    <ul class="sub-menu collapse on-sub mmpd" id="cs">
		...
		<a class="nav-link collapsed py-1 nav-link-11 edittext mucl" id="nav-1-animate-4" href="#csreport" data-toggle="collapse" data-target="#csreport">รายงาน<span data-feather="chevron-right"></a>
		    ...
		    <a class="nav-link collapsed py-1 nav-link-14 edittext mucl" id="nav-1-animate-6" href="#cssetting" data-toggle="collapse" data-target="#cssetting"><span data-feather="settings"></span>ตั้งค่า<span data-feather="chevron-right"></span></a>
