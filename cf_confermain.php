...
<div class='box2'>
		<?php
			$rs2 = "user,zoo,confer,event_confer  where admin.zoo_zoo_id = zoo.zoo_id && zoo.zoo_id = confer.zoo_zoo_id && confer.conferroom_id = event_confer.confer_confer_id && admin.zoo_zoo_id = $id";
			$rs = $db->findByPK4DESC('user','zoo','confer','event_confer','admin.zoo_zoo_id','zoo.zoo_id','zoo.zoo_id','confer.zoo_zoo_id','confer.conferroom_id','event_confer.confer_confer_id','admin.zoo_zoo_id',$id,$page,$limit)->execute();
